...
import os
import warnings
from Modules.classifiers.backbones import QuantumBackbone, ClassicalBackbone
from Modules.classifiers.classifiers import QuantumClassifier, ClassicalClassifier
...
class BaseModel(torch.nn.Module):
    ...
    def predict(self, X, use_cuda=None):
        y_pred = self.predict_proba(X, use_cuda)
